...
<html>
	...
	<body>
		<div class="pageinner">
			...
			<form  name='contact' method="post" action="Controleur?action=contactmail" onsubmit="return teste()">
			    ...
			    <span class="col-xs-6 col-xs-offset-3 noPadding mTop2em">
			        <input class="col-xs-12 inputStyle noOutline input-customPlaceholder" type="email" name="mail"
			        	placeholder="Votre e-mail" id ="mail" customplaceholder="0" autocomplete="on">
		        </span>
		        <span class="col-xs-6 col-xs-offset-3 noPadding mTop2em">
				  <textarea line="5" class="col-xs-12 inputStyle noOutline input-customPlaceholder" type="text" name="content"
					placeholder="Votre message" id ="content" customplaceholder="0" autocomplete="off"></textarea>
			    </span>         
